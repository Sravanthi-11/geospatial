...
function TestImpact() {
  ...
  return (
    <>
      <div className="testimpact-page">
      <video src='/videos/video3.mp4' autoPlay loop muted></video>
      <h1 className="location"></h1>
        <div className="testimpact-container">
          <div className="testimpact-left">
            <h2 className="headtestimpact">SEARCH</h2>
            <div className="testimpact-bar">
            ggh
            </div>
          </div>
          <div className="testimpact-right">
            <h2>PREDICTIONS</h2>
            <div className="value">
